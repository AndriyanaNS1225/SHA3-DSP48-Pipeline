...
HD_PWD='D:/Tugas/Skripsi/SourceCode/SHA-3/SHA-3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_SHA3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_SHA3.tcl -notrace
