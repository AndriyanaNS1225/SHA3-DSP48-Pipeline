...
HD_PWD='D:/Tugas/Skripsi/SourceCode/SHA-3/SHA-3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_SHA3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_SHA3.tcl
